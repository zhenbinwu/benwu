...
"      call Decho("l:cole=".&l:cole." l:cocu=".&l:cocu)
  ...
  syn region ansiUnderlineGreen	 start="\e\[;\=0\{0,2};\=\%(1;\)\=\%(4\|4\)m" end="\e\["me=e-2 contains=ansiConceal
  ...
  syn region ansiUnderline	 start="\e\[;\=0\{0,2};\=\%(1;\)\=\%(4\|4\)m" end="\e\["me=e-2 contains=ansiConceal
...
"   call Decho("set up 8-color highlighting groups")
   ...
   hi ansiUnderline         ctermfg=white      guifg=white                                        cterm=underline    gui=underline
