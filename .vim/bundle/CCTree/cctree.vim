...
if !exists('CCTreeKeyQuitTree ')
    let g:CCTreeKeyQuitTree = 'q'     " Compress call-tree
endif
...
function! s:CCTreeWindow.mEnter() dict
    ...
    if foundWindow == 0
        ...
        exec 'nnoremap <buffer> <silent> '.s:CCTreeKeyMappings.CTreeCompress.
                                                 \ ' :2,.foldclose!<CR>zv'
        exec 'nnoremap <buffer> <silent> '.s:CCTreeKeyMappings.CTreeQuit.
                                                 \ ' :q<CR>'

        nnoremap <buffer> <silent> <C-j> <C-W>j
        nnoremap <buffer> <silent> <C-k> <C-W>k
