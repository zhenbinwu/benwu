...
" ---------- C++ menu ----------------------------------------------------
"
 noremap    <buffer>  <silent>  <LocalLeader>t"         :call C_InsertTemplate("cpp.cout-operator")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>t"    <Esc>:call C_InsertTemplate("cpp.cout-operator")<CR>
 noremap    <buffer>  <silent>  <LocalLeader>to        :call C_InsertTemplate("cpp.cout")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>to   <Esc>:call C_InsertTemplate("cpp.cout")<CR>
 noremap    <buffer>  <silent>  <LocalLeader>td        :call C_InsertTemplate("cpp.debug")<CR><ESC>
inoremap    <buffer>  <silent>  <LocalLeader>td   <Esc>:call C_InsertTemplate("cpp.debug")<CR>
"
 noremap    <buffer>  <silent>  <LocalLeader>t         :call C_InsertTemplate("cpp.class-definition")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>t    <Esc>:call C_InsertTemplate("cpp.class-definition")<CR>
 noremap    <buffer>  <silent>  <LocalLeader>tn        :call C_InsertTemplate("cpp.class-using-new-definition")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>tn   <Esc>:call C_InsertTemplate("cpp.class-using-new-definition")<CR>

 noremap    <buffer>  <silent>  <LocalLeader>ti        :call C_InsertTemplate("cpp.class-implementation")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>ti   <Esc>:call C_InsertTemplate("cpp.class-implementation")<CR>
 noremap    <buffer>  <silent>  <LocalLeader>tni       :call C_InsertTemplate("cpp.class-using-new-implementation")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>tni  <Esc>:call C_InsertTemplate("cpp.class-using-new-implementation")<CR>
...
if !exists("g:C_Ctrl_j") || ( exists("g:C_Ctrl_j") && g:C_Ctrl_j != 'off' )
  ""nmap    <buffer>  <silent>  <C-j>    <C-R>=C_JumpCtrlJ()<CR>
