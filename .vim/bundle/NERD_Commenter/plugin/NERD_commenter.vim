...
call s:CreateMaps('nx', 'Sexy',       'Sexy', 'cz')
call s:CreateMaps('nx', 'Yank',       'Yank then comment', 'cy')
call s:CreateMaps('n',  'Append',     'Append', 'cl')
call s:CreateMaps('',   ':',          '-Sep-', '')
"call s:CreateMaps('nx', 'AlignLeft',  'Left aligned', 'cA')
call s:CreateMaps('nx', 'AlignBoth',  'Left and right aligned', 'cb')
call s:CreateMaps('',   ':',          '-Sep2-', '')
call s:CreateMaps('nx', 'Uncomment',  'Uncomment', 'co')
