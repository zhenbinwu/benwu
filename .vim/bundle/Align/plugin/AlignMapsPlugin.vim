...
if !hasmapto('<Plug>AM_tsp')	|map <unique> <Leader>tp	<Plug>AM_tsp|endif
if !hasmapto('<Plug>AM_tsq')	|map <unique> <Leader>tq	<Plug>AM_tsq|endif
if !hasmapto('<Plug>AM_tt')		|map <unique> <Leader>t&	<Plug>AM_tt|endif
