...
syn keyword elogType quote img list code line contained
syn keyword elogCat Type Category Subject contained
syn match bbcodeItem contained "\[\s*[-a-zA-Z0-9]\+"hs=s+1 contains=@NoSpell,elogType
syn match bbcodeItem contained "\[/\s*[-a-zA-Z0-9]\+"hs=s+2 contains=@NoSpell,elogType
syn match bbcodeItem contained "\[\s*\*\s*\]"hs=s+1,he=e-1 contains=@NoSpell,elogType
syn match bbcodeArgument contained "\s[-a-zA-Z0-9]\+\s*="ms=s+1,me=e-1 contains=@NoSpell,elogType
...
hi link elogType SpecialChar
hi link elogCat  SpecialComment
hi link elogComment Comment
