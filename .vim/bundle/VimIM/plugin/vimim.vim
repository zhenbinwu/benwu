...
let s:egg = ' $Date: 2012-01-03 22:12:53 -0800 (Tue, 03 Jan 2012) $'
let s:egg = ' $Revision: 11485 $'
...
function! s:vimim_initialize_backdoor()
    ...
    let s:hit_and_run = 0 "Always allow hit and run 
    "if len(s:cjk.filename) "Commented by me to keep the memu visitable 
